...
import src.examen.parc201911.TablaEstadistica.CalculadorColumna;
...
public class PruebaTablas {
	...
	private static void sacaVentanasPrueba() {
		...
		private static void cambioDeValor( Tabla tabla, int fila, int columna, Object valorNuevo ) {
			// TODO T2
			// Actualizar el valor de la fila correspondiente de Dato (identificada por su nick) y de la columna
			// correspondiente (de acuerdo al número de columna que se recibe en el método). 
			BD.updateValor(tabla, fila, columna);
		}
