	...
	public VentanaTabla( VentanaGeneral ventMadre, String titulo, boolean... horizontalScroll ) {
		...
		tDatos.addMouseListener( new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				if ( fila >= 0 && filaDestino >= 0 && columna >= 0 && columnaDestino >= 0 ) {
					Object obj1 = tablaDatos.get( fila, columna );
					Object obj2 = tablaDatos.get( filaDestino, columnaDestino );
					if (obj1 != null && obj2!=null && obj1.getClass() == obj2.getClass()) {
						tablaDatos.set( fila, columna, obj2 );
						tablaDatos.set( filaDestino, columnaDestino, obj1 );
					}
				}
			}
		});
		...
		addInternalFrameListener( new InternalFrameAdapter() {
			...
			public void internalFrameActivated( InternalFrameEvent e ) {
				if ( tablaDatos instanceof TablaAnalisis ) {
					TablaAnalisis tabAna = ( TablaAnalisis ) tablaDatos;
					if ( tabAna.getGrafico() != null ) {
						tabAna.getGrafico().getJFrame().setVisible( true );
					}
				}
			}
		});
